...
void decifraComChave(unsigned char *key){
...
int main(){
    ...
    unsigned char FinalKey[16] = "Key2Group17";
    FinalKey[11] = missingKey[0];
    FinalKey[12] = missingKey[1];
    FinalKey[13] = missingKey[2];
    FinalKey[14] = missingKey[3];
    FinalKey[15] = missingKey[4];

    decifraComChave(FinalKey);
